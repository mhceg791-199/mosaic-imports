  ...
  return (
    <section className="relative md:py-12 overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 w-3/4 mx-auto text-center md:py-8">
        ...
        <Paragraph
          p="If you’re driven by excellence and eager to leave your mark on the built environment, explore our opportunities. At Mosaic Imports, we invest in your potential, empower your ambition, and champion your journey to redefine engineering excellence."
        />

...
Information we may gather includes, but is not limited to:"
          list={[
            ...
            "Usage Data: Data on interaction patterns with Mosaic Imports platforms to enhance service quality and user experience.",
          ]}
        />
        <TitleWithList
          title="PURPOSE OF DATA COLLECTION"
          text="Mosaic Imports collects personal data solely to improve the quality of our services, enhance operational efficiency, and foster a secure and personalized user experience. Primary purposes include:"
          list={[
...
or destruction. This includes encryption protocols, secure data storage, and stringent access controls."
        ...
        <TitleWithList
          ...
          text="Mosaic Imports respects your privacy and does not share personal information with unaffiliated third parties except as outlined in this policy. Data may be shared under the following conditions:"
          list={[
        ...
        <TitleWithList
          ...
          text="Mosaic Imports reserves the right to amend this Privacy Policy to reflect changes in our practices, regulatory requirements, or other operational considerations. All updates will be published on our website, with the 'Last Updated' date indicating the most recent revisions."
        />
        <TitleWithList
          title="CONTACT US"
